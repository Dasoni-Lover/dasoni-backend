...
public class GeminiVoiceScriptServiceImpl {
    ...
    public String generateVoiceReplyScript(String currentLetterContent,
        ...
        String template = """
                ...
                답장은 ‘고인이 살아있다고 가정한 화자’가 아니라, ‘부재를 인식한 고인의 시선과 태도’에서 작성되어야 합니다.
                ...
                - 다른 텍스트는 절대 포함하지 마시오.
                - 답장은 ‘이별 이후에도 관계가 이어진다는 전제’가 아니라,‘관계는 남아 있으나 삶은 분리되어 있다’는 인식 위에서 시작하시오.
                - 답장은 고인의 ‘기억과 태도’를 빌린 응답이지, 고인의 사후 독백이 아니다.
                """;
